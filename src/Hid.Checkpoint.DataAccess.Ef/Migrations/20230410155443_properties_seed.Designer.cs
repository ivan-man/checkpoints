...
namespace Hid.Checkpoint.DataAccess.Ef.Migrations
{
    ...
    [Migration("20230410155443_properties_seed")]
    partial class properties_seed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.User", b =>
                {
                    ...
                    b.HasIndex("ApproveStageId")
                        .HasDatabaseName("ix_user_approve_stage_id");
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.OrganizationProperty", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "Hid.Checkpoint.Domain.Models.Organization.ContractDescription",
                            Created = new DateTime(1999, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Договор",
                            InterfaceId = "Hid.Checkpoint.Domain.Models.Organization.ContractDescription",
                            IsHidden = false,
                            Removed = false,
                        ...
                        new
                        {
                            Id = "Hid.Checkpoint.Domain.Models.Organization.Title",
                            Created = new DateTime(1999, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Заголовок",
                            InterfaceId = "Hid.Checkpoint.Domain.Models.Organization.Title",
                            IsHidden = false,
                            Removed = false,
                            Name = "Title",
                            TypeFullName = "Hid.Checkpoint.Domain.Models.Organization",
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.ProfileProperty", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "Hid.Checkpoint.Domain.Models.Profile.FirstName",
                            Created = new DateTime(1999, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Имя",
                            InterfaceId = "Hid.Checkpoint.Domain.Models.Profile.FirstName",
                            IsHidden = false,
                            Removed = false,
                            Name = "FirstName",
                            TypeFullName = "Hid.Checkpoint.Domain.Models.Profile",
                        ...
                        new
                        {
                            Id = "Hid.Checkpoint.Domain.Models.Profile.LastName",
                            Created = new DateTime(1999, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Фамилия",
                            InterfaceId = "Hid.Checkpoint.Domain.Models.Profile.LastName",
                            IsHidden = false,
                            Removed = false,
                            Name = "LastName",
                            TypeFullName = "Hid.Checkpoint.Domain.Models.Profile",
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.ApproveStage", b =>
                {
                    b.HasOne("Hid.Checkpoint.Domain.Models.User", "Approver")
                        .WithMany()
                        .HasForeignKey("ApproverId")
                        .HasConstraintName("fk_approve_stage_user_approver_id");
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.User", b =>
                {
                    ...
                    b.HasOne("Hid.Checkpoint.Domain.Models.ApproveStage", null)
                        ...
                        .HasConstraintName("fk_user_approve_stage_approve_stage_id");
