...
namespace Hid.Checkpoint.DataAccess.Ef.Migrations
{
    ...
    [Migration("20230516164237_organization_contract_relations")]
    partial class organization_contract_relations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.GuestContractRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("OrganizationContractId")
                        .HasColumnType("integer")
                        .HasColumnName("organization_contract_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_organization_contract_relations");

                    b.HasIndex("OrganizationContractId")
                        .HasDatabaseName("ix_organization_contract_relations_organization_contract_id");

                    b.HasIndex("PassRequestId")
                        .HasDatabaseName("ix_organization_contract_relations_pass_request_id");

                    b.HasIndex("PersonId")
                        .HasDatabaseName("ix_organization_contract_relations_person_id");

                    b.ToTable("organization_contract_relations", (string)null);
                });
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.AccessLevel", b =>
                {
                    ...
                    b.Property<int?>("ApprovePermissionId")
                        .HasColumnType("integer")
                        .HasColumnName("approve_permission_id");

                    b.Property<int?>("ApproverPermissionRequestId")
                        .HasColumnType("integer")
                        .HasColumnName("approver_permission_request_id");
                    ...
                    b.HasIndex("ApprovePermissionId")
                        .HasDatabaseName("ix_access_levels_approve_permission_id");

                    b.HasIndex("ApproverPermissionRequestId")
                        .HasDatabaseName("ix_access_levels_approver_permission_request_id");
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.ApprovePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("PassRequestTypeId")
                        .HasColumnType("integer")
                        .HasColumnName("pass_request_type_id");
                    ...
                    b.Property<int?>("StageTemplateId")
                        .HasColumnType("integer")
                        .HasColumnName("stage_template_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_approve_permissions");

                    b.HasIndex("PassRequestTypeId")
                        .HasDatabaseName("ix_approve_permissions_pass_request_type_id");

                    b.HasIndex("PersonId")
                        .HasDatabaseName("ix_approve_permissions_person_id");

                    b.HasIndex("StageTypeId")
                        .HasDatabaseName("ix_approve_permissions_stage_type_id");

                    b.HasIndex("SubdivisionId")
                        .HasDatabaseName("ix_approve_permissions_subdivision_id");

                    b.ToTable("approve_permissions", (string)null);
                });
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.ApproverPermissionRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_approver_permission_requests");

                    b.HasIndex("AuthorId")
                        .HasDatabaseName("ix_approver_permission_requests_author_id");

                    b.HasIndex("PassRequestTypeId")
                        .HasDatabaseName("ix_approver_permission_requests_pass_request_type_id");

                    b.HasIndex("PersonId")
                        .HasDatabaseName("ix_approver_permission_requests_person_id");

                    b.HasIndex("StageTypeId")
                        .HasDatabaseName("ix_approver_permission_requests_stage_type_id");

                    b.HasIndex("SubdivisionId")
                        .HasDatabaseName("ix_approver_permission_requests_subdivision_id");

                    b.ToTable("approver_permission_requests", (string)null);
                });
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.PersonProperty", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "Hid.Checkpoint.Domain.Models.Person.UserId",
                            Created = new DateTime(1999, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InterfaceId = "Hid.Checkpoint.Domain.Models.Person.UserId",
                            IsHidden = false,
                            Name = "UserId",
                            Removed = false,
                            TypeFullName = "Hid.Checkpoint.Domain.Models.Person",
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.RequestProperty", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "Hid.Checkpoint.Domain.Models.PassRequest.GuestContractRelations",
                            Created = new DateTime(1999, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "",
                            InterfaceId = "Hid.Checkpoint.Domain.Models.PassRequest.GuestContractRelations",
                            IsHidden = false,
                            Name = "GuestContractRelations",
                            Removed = false,
                            TypeFullName = "Hid.Checkpoint.Domain.Models.PassRequest",
                            TypeName = "PassRequest",
                            Updated = new DateTime(1999, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.GuestContractRelation", b =>
                {
                    b.HasOne("Hid.Checkpoint.Domain.Models.OrganizationContract", "OrganizationContract")
                        .WithMany("GuestContractRelations")
                        .HasForeignKey("OrganizationContractId")
                        .HasConstraintName("fk_organization_contract_relations_organization_contracts_orga");
                    ...
                    b.HasOne("Hid.Checkpoint.Domain.Models.PassRequest", "PassRequest")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_organization_contract_relations_pass_requests_pass_request_");
                    ...
                    b.HasOne("Hid.Checkpoint.Domain.Models.Person", "Person")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_organization_contract_relations_persons_person_id");
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.AccessLevel", b =>
                {
                    b.HasOne("Hid.Checkpoint.Domain.Models.ApprovePermission", null)
                        .WithMany("AccessLevels")
                        .HasForeignKey("ApprovePermissionId")
                        .HasConstraintName("fk_access_levels_approve_permissions_approve_permission_id");

                    b.HasOne("Hid.Checkpoint.Domain.Models.ApproverPermissionRequest", null)
                        .WithMany("AccessLevels")
                        .HasForeignKey("ApproverPermissionRequestId")
                        .HasConstraintName("fk_access_levels_approver_permission_requests_approver_permiss");
                });
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.ApprovePermission", b =>
                {
                    b.HasOne("Hid.Checkpoint.Domain.Models.PassRequestType", "RequestType")
                        .WithMany()
                        .HasForeignKey("PassRequestTypeId")
                        .HasConstraintName("fk_approve_permissions_pass_request_type_pass_request_type_id");
                    ...
                    b.HasOne("Hid.Checkpoint.Domain.Models.Person", "Person")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_approve_permissions_persons_person_id");

                    b.HasOne("Hid.Checkpoint.Domain.Models.StageType", "StageType")
                        .WithMany()
                        .HasForeignKey("StageTypeId")
                        .HasConstraintName("fk_approve_permissions_stage_type_stage_type_id");

                    b.HasOne("Hid.Checkpoint.Domain.Models.Subdivision", "Subdivision")
                        .WithMany()
                        .HasForeignKey("SubdivisionId")
                        .HasConstraintName("fk_approve_permissions_subdivision_subdivision_id");

                    b.OwnsOne("Hid.Checkpoint.Domain.Models.StageTemplate", "StageTemplate", b1 =>
                        {
                            b1.Property<int>("ApprovePermissionId")
                                .HasColumnType("integer")
                                .HasColumnName("id");

                            b1.Property<int>("ChainTemplateId")
                                .HasColumnType("integer")
                                .HasColumnName("stage_template_chain_template_id");

                            b1.Property<bool>("IsDisabled")
                                .HasColumnType("boolean")
                                .HasColumnName("stage_template_is_disabled");

                            b1.Property<int>("Order")
                                .HasColumnType("integer")
                                .HasColumnName("stage_template_order");

                            b1.Property<int>("TypeId")
                                .HasColumnType("integer")
                                .HasColumnName("stage_template_type_id");

                            b1.HasKey("ApprovePermissionId");

                            b1.HasIndex("ChainTemplateId")
                                .HasDatabaseName("ix_approve_permissions_stage_template_chain_template_id");

                            b1.HasIndex("TypeId")
                                .HasDatabaseName("ix_approve_permissions_stage_template_type_id");

                            b1.ToTable("approve_permissions");

                            b1.WithOwner()
                                .HasForeignKey("ApprovePermissionId")
                                .HasConstraintName("fk_approve_permissions_approve_permissions_id");
                            ...
                            b1.HasOne("Hid.Checkpoint.Domain.Models.ChainTemplate", "ChainTemplate")
                                ...
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired()
                                .HasConstraintName("fk_approve_permissions_chain_template_stage_template_chain_tem");
                            ...
                            b1.HasOne("Hid.Checkpoint.Domain.Models.StageType", "Type")
                                ...
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired()
                                .HasConstraintName("fk_approve_permissions_stage_type_stage_template_type_id");
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.ApproverPermissionRequest", b =>
                {
                    b.HasOne("Hid.Checkpoint.Domain.Models.Person", "Author")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_approver_permission_requests_persons_author_id");

                    b.HasOne("Hid.Checkpoint.Domain.Models.PassRequestType", "PassRequestType")
                        .WithMany()
                        .HasForeignKey("PassRequestTypeId")
                        .HasConstraintName("fk_approver_permission_requests_pass_request_type_pass_request");
                    ...
                    b.HasOne("Hid.Checkpoint.Domain.Models.Person", "Person")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_approver_permission_requests_persons_person_id");

                    b.HasOne("Hid.Checkpoint.Domain.Models.StageType", "StageType")
                        .WithMany()
                        .HasForeignKey("StageTypeId")
                        .HasConstraintName("fk_approver_permission_requests_stage_type_stage_type_id");

                    b.HasOne("Hid.Checkpoint.Domain.Models.Subdivision", "Subdivision")
                        .WithMany()
                        .HasForeignKey("SubdivisionId")
                        .HasConstraintName("fk_approver_permission_requests_subdivision_subdivision_id");

                    b.OwnsOne("Hid.Checkpoint.Domain.Models.StageTemplate", "StageTemplate", b1 =>
                        {
                            b1.Property<int>("ApproverPermissionRequestId")
                                .HasColumnType("integer")
                                .HasColumnName("id");
                            ...
                            b1.HasKey("ApproverPermissionRequestId");

                            b1.HasIndex("ChainTemplateId")
                                .HasDatabaseName("ix_approver_permission_requests_stage_template_chain_template_");

                            b1.HasIndex("TypeId")
                                .HasDatabaseName("ix_approver_permission_requests_stage_template_type_id");

                            b1.ToTable("approver_permission_requests");

                            b1.WithOwner()
                                .HasForeignKey("ApproverPermissionRequestId")
                                .HasConstraintName("fk_approver_permission_requests_approver_permission_requests_id");
                            ...
                            b1.HasOne("Hid.Checkpoint.Domain.Models.ChainTemplate", "ChainTemplate")
                                ...
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired()
                                .HasConstraintName("fk_approver_permission_requests_chain_template_stage_template_");
                            ...
                            b1.HasOne("Hid.Checkpoint.Domain.Models.StageType", "Type")
                                ...
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired()
                                .HasConstraintName("fk_approver_permission_requests_stage_type_stage_template_type");
            ...
            modelBuilder.Entity("Hid.Checkpoint.Domain.Models.OrganizationContract", b =>
                {
                    b.Navigation("GuestContractRelations");
                });
