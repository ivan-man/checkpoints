...
public class RemoveUserRoleCommandHandler : IRequestHandler<AddUserRoleCommand, Result>
{
    ...
    public RemoveUserRoleCommandHandler(RoleManager<ApplicationUserRole> roleManager, UserManager<ApplicationUser> userManager, ILogger<SetRolesCommandHandler> logger, IMediator mediator)
    {
